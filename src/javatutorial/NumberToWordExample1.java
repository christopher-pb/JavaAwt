...
//executes if the length of the string is greater than equal to three
            if (len >= 3)
            {
                if (num[x] - '0' != 0)
                {
                    out.print(onedigit[num[x] - '0'] + " ");
//here length can be 3 or 4
                    out.print(poweroftens[len - 3]+ " ");
                }
